...
public class ShadowParser extends Parser {
    ...
    public static final String _serializedATN =
            "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\62\u0083\4\2\t\2" +
                    ...
                    "\t\2de\7\6\2\2ef\5\4\3\2f\23\3\2\2\2gh\7\16\2\2h\25\3\2\2\2ij\7\n\2\2" +
                    "j\27\3\2\2\2kl\7\17\2\2lm\5\20\t\2mn\7\34\2\2nr\7\22\2\2oq\5\4\3\2po\3" +
    ...
    public final Zapytanie_jesliContext zapytanie_jesli() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                setState(96);
                ((Zapytanie_jesliContext) _localctx).znak = _input.LT(1);
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << WIEKSZE) | (1L << MNIEJSZE) | (1L << POROWNANIE) | (1L << NIEROWNE))) != 0))) {
                    ((Zapytanie_jesliContext) _localctx).znak = (Token) _errHandler.recoverInline(this);
                } else {
                    if (_input.LA(1) == Token.EOF) matchedEOF = true;
                    _errHandler.reportMatch(this);
                    consume();
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public List<TerminalNode> SREDNIK() {
            return getTokens(ShadowParser.SREDNIK);
        }
    ...
    public static class WypiszContext extends ParserRuleContext {
        ...
        public List<TerminalNode> ZNAKI() {
            return getTokens(ShadowParser.ZNAKI);
        }
        ...
        public List<TerminalNode> WYKRZYKNIK() {
            return getTokens(ShadowParser.WYKRZYKNIK);
        }
        ...
        public List<TerminalNode> CUDZYSLOW() {
            return getTokens(ShadowParser.CUDZYSLOW);
        }
        ...
        public List<TerminalNode> PRZECINEK() {
            return getTokens(ShadowParser.PRZECINEK);
        }
        ...
        public List<TerminalNode> KROPKA() {
            return getTokens(ShadowParser.KROPKA);
        }
        ...
        public List<TerminalNode> PYTAJNIK() {
            return getTokens(ShadowParser.PYTAJNIK);
        }
    ...
    public static class UtworzeniestalejContext extends Utworzenie_stalejContext {
        ...
        public UtworzeniestalejContext(Utworzenie_stalejContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode STALA() {
            return getToken(ShadowParser.STALA, 0);
        }

        public TerminalNode PRZYPISANIE() {
            return getToken(ShadowParser.PRZYPISANIE, 0);
        }
    ...
    public static class Utworzenie_zmiennejContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_utworzenie_zmiennej;
        }
    ...
    public static class UtworzeniezmiennejContext extends Utworzenie_zmiennejContext {
        ...
        public UtworzeniezmiennejContext(Utworzenie_zmiennejContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ZMIENNA() {
            return getToken(ShadowParser.ZMIENNA, 0);
        }
    ...
    public static class ZmianazmiennejContext extends Zmiana_zmiennejContext {
        ...
        public ZmianazmiennejContext(Zmiana_zmiennejContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class WyrazeniematematyczneContext extends WyrazenieContext {
        ...
        public WyrazeniematematyczneContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ZNAK_MATEMATYCZNY() {
            return getToken(ShadowParser.ZNAK_MATEMATYCZNY, 0);
        }
    ...
    public static class WyrazeniezwiekszenieContext extends WyrazenieContext {
        ...
        public WyrazeniezwiekszenieContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ZWIEKSZENIE() {
            return getToken(ShadowParser.ZWIEKSZENIE, 0);
        }
    ...
    public static class WyrazeniezmniejszenieContext extends WyrazenieContext {
        ...
        public WyrazeniezmniejszenieContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ZMNIEJSZENIE() {
            return getToken(ShadowParser.ZMNIEJSZENIE, 0);
        }
    ...
    public static class WyrazeniefunkcjaContext extends WyrazenieContext {
        public WyrazeniefunkcjaContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class KolejnedzialanieContext extends WyrazenieContext {
        ...
        public KolejnedzialanieContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class WyrazenienawiasContext extends WyrazenieContext {
        public WyrazenienawiasContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode LEWYNAW() {
            return getToken(ShadowParser.LEWYNAW, 0);
        }
        ...
        public TerminalNode PRAWYNAW() {
            return getToken(ShadowParser.PRAWYNAW, 0);
        }
    ...
    public static class WyrazenieznakoweContext extends WyrazenieContext {
        public WyrazenieznakoweContext(WyrazenieContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ZNAKI() {
            return getToken(ShadowParser.ZNAKI, 0);
        }
    ...
    public static class Zapytanie_jesliContext extends ParserRuleContext {
        ...
        public TerminalNode JESLI() {
            return getToken(ShadowParser.JESLI, 0);
        }
        ...
        public TerminalNode POROWNANIE() {
            return getToken(ShadowParser.POROWNANIE, 0);
        }

        public TerminalNode WIEKSZE() {
            return getToken(ShadowParser.WIEKSZE, 0);
        }

        public TerminalNode MNIEJSZE() {
            return getToken(ShadowParser.MNIEJSZE, 0);
        }

        public TerminalNode NIEROWNE() {
            return getToken(ShadowParser.NIEROWNE, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_zapytanie_jesli;
        }
    ...
    public static class Petla_dopokiContext extends ParserRuleContext {
        ...
        public TerminalNode DOPOKI() {
            return getToken(ShadowParser.DOPOKI, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_petla_dopoki;
        }
    ...
    public static class Petla_dlaContext extends ParserRuleContext {
        ...
        public TerminalNode DLA() {
            return getToken(ShadowParser.DLA, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_petla_dla;
        }
    ...
    public static class Deklaracja_funkcjiContext extends ParserRuleContext {
        ...
        public TerminalNode FUNKCJA() {
            return getToken(ShadowParser.FUNKCJA, 0);
        }
        ...
        public TerminalNode LNAWIAS() {
            return getToken(ShadowParser.LNAWIAS, 0);
        }

        public TerminalNode PNAWIAS() {
            return getToken(ShadowParser.PNAWIAS, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_deklaracja_funkcji;
        }
